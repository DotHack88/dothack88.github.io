<div class='wrap'>
	<div id='elite_player_admin'>
		<a href="admin.php?page=elite_player_admin" class="back-to-list-link">&larr; <?php esc_html_e('Back to players list', 'player'); ?></a>
		...
		<form method="post" id="elite-options-form" enctype="multipart/form-data" action="admin-ajax.php?page=elite_player_admin&action=save_settings&playerId=<?php esc_html_e($current_id)?>">
...
wp_enqueue_style( 'readvideo_player_admin_css', plugins_url()."/Elite-video-player/css/player-admin.min.css",array(), ELITE_PLAYER_VERSION );
wp_enqueue_style( 'jquery-ui-style', plugins_url()."/Elite-video-player/css/jquery-ui.min.css",array(), ELITE_PLAYER_VERSION );
